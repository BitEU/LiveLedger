...
if %ERRORLEVEL% EQU 0 (
    ...
    if %ERRORLEVEL% EQU 0 (
        ...
        cl /O2 /W3 /TC main.c sheet.c console.c charts.c /Fe:LL.exe /link resource.res user32.lib
    ) else (
        echo Warning: Resource compilation failed, building without icon...
        cl /O2 /W3 /TC main.c sheet.c console.c charts.c /Fe:LL.exe /link user32.lib
    )
) else (
